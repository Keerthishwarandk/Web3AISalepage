  ...
  return (
    <>
      ...
      <section className="relative py-16 px-4 overflow-hidden" id="schedule">
        ...
        {/* Elegant floating elements - smaller */}
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {/* Premium Schedule Timeline - smaller */}
          <div className="relative">
            {scheduleItems.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Luxury content container - smaller padding */}
                  <div className="relative z-10 p-6">
                    <div className="flex items-start gap-6">
                      {/* Icon & Timeline - smaller */}
                      ...
                      <div className="flex-1">
                        ...
                        {/* Title with premium styling - smaller */}
          ...
          {/* Premium Call to Action - smaller */}
